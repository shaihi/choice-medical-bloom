...
const navLinks = [
  { label: "Problem", id: "contrast" },
  { label: "Technology", id: "science" },
    ...
    >
      <div className="max-w-6xl mx-auto flex justify-between items-center">
        ...
        <button
          ...
          aria-label="Choice Medical — go to top"
        >
          <img
        ...
        <div className="md:hidden mt-3 bg-[#0A1C33] border border-white/10 rounded-xl py-4 px-4 space-y-1">
          ...
          <div className="pt-3">
            <button
              ...
              className="w-full bg-[#1CC5DC] hover:bg-[#1CC5DC]/90 text-[#0A1C33] font-semibold px-5 py-3 rounded-lg text-sm transition-colors"
            >
              Request Deck
            </button>
          </div>
