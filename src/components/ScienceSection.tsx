...
const ScienceSection = () => {
  ...
  const { t } = useLanguage();
  const credentials = t.science.credentials;
  ...
  return (
    ...
    >
      ...
      <div className="max-w-6xl mx-auto px-6 w-full">
        ...
        >
          <p className="text-[#1CC5DC] text-xs uppercase tracking-[0.2em] mb-10">{t.science.eyebrow}</p>

          <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-white leading-[1.05] mb-8 max-w-4xl">
            {t.science.heading1}{" "}
            <span className="text-[#1CC5DC]">{t.science.headingHighlight}</span>
            {" "}{t.science.heading2}
          </h2>
